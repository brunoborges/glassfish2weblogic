 ...
 * @author bruno
 */
public class WSClientGlassFishTest {

    @Test
    public void testWSClient_GlassFish() throws MalformedURLException {
        URL glassFish = new URL("http://localhost:8080/bookmark-javaee6/BookmarkWebService?WSDL");
